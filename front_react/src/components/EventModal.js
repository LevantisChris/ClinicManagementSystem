...
export default function EventModal() {
    ...
    const [title, setTitle] = useState(selectedEvent ? selectedEvent.title : ""); /* with the selectedEvent we can populate the title that the use already has added */
    ...
    return (
        <div className={'h-screen w-full fixed left-0 top-0 flex justify-center items-center'}>
            <form className={'bg-amber-50 rounded-lg shadow-2xl w-1/4'}>
