...
export default function RegisterPatientsMassively() {
    ...
    const TABLE_HEAD = ["First-name","Second-name", "Email", "AMKA", "Date registered"];
                    ...
                    <a href="/path/to/your/file.ext" download
                       className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-blue-800 dark:bg-blue-700 hover:bg-gray-100 dark:border-blue-600 dark:hover:border-gray-500">
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400">Download your file here</p>
                        </div>
                    </a>
                </div>
            </div>
            ...
            { TABLE_ROWS.length !== 0 ?
                <div className={"mt-4"}>
                    <div className={"grid grid-cols-2 gap-2"}>
                        ...
                        <Button className={"w-full h-full bg-green-500"}>Register patients</Button>
                    </div>
