...
export default function RegisterPatient() {
    ...
    const TABLE_HEAD = [(viewEnglish ? "Full-name" : "Όνομα"), (viewEnglish ? "Email" : "Email"), "AMKA", (viewEnglish ? "Date registered" : "Ημερομηνία καταχώρισης")];
    ...
    return (
        <div className="flex flex-col h-min w-screen sm:w-full p-2 sm:p-10 cursor-default">
            <p className="font-light text-3xl md:text-5xl">
                {viewEnglish ? "Register a patient by providing their info" : "Εισαγωγή ασθενή"}
            </p>
            <p className="mt-2 pr-10 font-light text-slate-400 text-sm md:text-base">
                {viewEnglish ? "A password will be automatically generated by the system"
                    : "Ένας κωδικός τα δημιουργηθεί αυτόματα από το σύστημα"}
            </p>
            ...
            <form className="w-full h-full mx-auto mt-5">
                ...
                <div className="z-0 w-full mb-5 group">
                    <input
                        ...
                        placeholder={viewEnglish ? "Email address" : "Email"}
                        required
                        value={email}
                ...
                <div className="">
                    <div className="z-0 w-full mb-5 group">
                        <input
                            ...
                            className="block py-2.5 px-0 w-max sm:w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder={viewEnglish ? "First name" : "Όνομα"}
                            required
                            value={firstName}
                    ...
                    <div className="z-0 w-full mb-5 group">
                        <input
                            ...
                            className="block py-2.5 px-0 w-max sm:w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder={viewEnglish ? "Last name" : "Επώνυμο"}
                            required
                            value={lastName}
                ...
                <div className="">
                    ...
                    <div className="z-0 w-full mb-5 group">
                        <input
                            ...
                            id="id_number"
                            className="block py-2.5 px-0 w-max sm:w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder={viewEnglish ? "ID number" : "Αριθμός ταυτότητας"}
                            required
                            value={idnumber}
                    ...
                    {error ?
                        <div className="z-0 w-full mb-5 group">
                            <label className="text-red-600">
                                {viewEnglish ? "An error occurred" : "Παρουσιάστηκε σφάλμα"}
                            </label>
                        </div>
                        : success
                            ?
                            <div className="z-0 w-full mb-5 group">
                                <label className="text-green-600">
                                    {viewEnglish ? "The patient registered successfully" : "Η εισαγωγή ήταν επιτυχής"}
                                </label>
                            </div> : ""
                    }
                </div>
            ...
            <p className={"mt-5 pr-10 font-light text-3xl md:text-5xl"}>
                {viewEnglish ? "Some, already registered patients" : "Ορισμένοι, ήδη εγγεγραμμένοι ασθενείς"}
            </p>
